...
void world::init()
{
    ...
    fprintf(log,"%ux%u\tWYP_POT=%f\tEFEKT=%f\tMAX_WIEK=%d\tPLOD=%f\tRTG=%f\tBUM=0.5^%d\n",
        WORLD_SIDE,WORLD_SIDE*2,OFFSPRING_DOWRY,AUTOTROPH_EFFICIENCY,
        (int)(255-MINIMAL_AGE),1./INFERTILITY,1./RADIATION,DISASTER_EXP);
...
double poisson(int n); // generate a para-poison distribution in the range 0..1 with 'n' degrees
